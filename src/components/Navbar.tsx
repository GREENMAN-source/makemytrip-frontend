  ...
  return (
    <header className=" backdrop-blur-md py-4 sticky top-0 z-50">
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        {/* MODIFIED: Added onClick and cursor-pointer to make the logo clickable */}
        <div 
          onClick={() => router.push("/")} 
          className="flex items-center space-x-2 text-white cursor-pointer hover:opacity-80 transition-opacity"
        >
